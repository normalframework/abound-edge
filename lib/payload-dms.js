...
//   _path  "<siteName>/<equipRef>", or the 4-part
//          "<siteName>/<areaServed>/<equipServes>/<equipRef>" when the
//          equipment carries both an area_served and an equip_serves value
//          (see ids.equipPath).
...
function build(settings, devices, sitesMeta = {}) {
  ...
  for (const dev of devices) {
    ...
    obj._path = ids.equipPath(siteName, dev.equipRef, dev.areaServed, dev.equipServes);
